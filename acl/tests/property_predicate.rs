...
/// The address trait these fixtures need: [`IpAddress`] (seal, width, `FixedSize`) plus the
/// generator, which cannot be a bound on `IpAddress` itself because `net`'s bolero support is
/// optional.
