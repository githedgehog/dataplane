...
///
/// Checked: every `.derivative()` in the tree is either one of this trait's own
...
/// exported rate does pass through, had exactly one claim on it (`is_ok()`) before this. Two
