~/code/githedgehog/dataplane/scripts ~/code/githedgehog/dataplane
## No new CVEs reported by scan
...
This vulnerability does not affect the dataplane because we do not use gcc to build anything.
All dependencies (save glibc) are compiled with LLVM.
