...
impl IpForwarder {
    ...
    /// Encapsulate a packet in Vxlan with the provided [`ResolvedVxlan`] params
    ...
    /// Execute an encapsulation instruction on a packet as indicated by [`ResolvedEncapsulation`]
