...
/// A thirty-minute libFuzzer campaign died on it -- seven `oom-*` artifacts against the 2GB default.
///
...
mod model {
    ...
    /// break test below drops the restriction, and among what it produces is exactly this:
