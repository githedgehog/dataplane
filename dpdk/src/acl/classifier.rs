    ...
    pub fn add_rules(
        ...
        for (i, rule) in rules.iter().enumerate() {
            ...
            let data_bytes: &[u8] = unsafe {
                core::slice::from_raw_parts(&rule.data as *const RuleData as *const u8, data_size)
            };
            ...
            buf[fields_offset..fields_offset + fields_bytes.len()].copy_from_slice(fields_bytes);
        }
