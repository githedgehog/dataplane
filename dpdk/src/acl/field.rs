...
pub enum FieldType {
    ...
    ///
    /// Corresponds to [`RTE_ACL_FIELD_TYPE_MASK`][dpdk_sys::acl_const::RTE_ACL_FIELD_TYPE_MASK].
    Mask = 0,
    ...
    ///
    /// Corresponds to [`RTE_ACL_FIELD_TYPE_RANGE`][dpdk_sys::acl_const::RTE_ACL_FIELD_TYPE_RANGE].
    Range = 1,
    ...
    /// and `mask_range = 0xFF`.
    ///
    /// Corresponds to [`RTE_ACL_FIELD_TYPE_BITMASK`][dpdk_sys::acl_const::RTE_ACL_FIELD_TYPE_BITMASK].
    Bitmask = 2,
}
...
mod tests {
    ...
    fn field_type_discriminants_match_dpdk() {
        assert_eq!(
            ...
            dpdk_sys::acl_const::RTE_ACL_FIELD_TYPE_MASK as u8
        );
        assert_eq!(
            FieldType::Range as u8,
            dpdk_sys::acl_const::RTE_ACL_FIELD_TYPE_RANGE as u8
        );
        assert_eq!(
            FieldType::Bitmask as u8,
            dpdk_sys::acl_const::RTE_ACL_FIELD_TYPE_BITMASK as u8
        );
    }
