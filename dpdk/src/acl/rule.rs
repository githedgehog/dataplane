...
pub mod priority {
    ...
    ///
    /// Corresponds to
    /// [`RTE_ACL_MIN_PRIORITY`][dpdk_sys::acl_const::RTE_ACL_MIN_PRIORITY].
    pub const MIN: i32 = dpdk_sys::acl_const::RTE_ACL_MIN_PRIORITY;

    /// Maximum valid rule priority (inclusive).
    ///
    /// Corresponds to
    /// [`RTE_ACL_MAX_PRIORITY`][dpdk_sys::acl_const::RTE_ACL_MAX_PRIORITY].
    pub const MAX: i32 = dpdk_sys::acl_const::RTE_ACL_MAX_PRIORITY;
}
...
mod tests {
    ...
    fn priority_constants_match_dpdk() {
        ...
        assert_eq!(priority::MAX, dpdk_sys::acl_const::RTE_ACL_MAX_PRIORITY);
    }
