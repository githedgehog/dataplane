...
npins add github githedgehog rdma-core --branch fix-lto-65.0 # Floats with branch on pin bump
...
npins add github githedgehog dpdk --branch v26.07-hh
...
npins add github FRRouting frr --upper-bound 10.8 --release-prefix frr- # floats within 10.7.x on pin bump
