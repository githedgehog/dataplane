...
npins add github rust-lang rust # Will bump on rust releases.  Source not used directly.
npins add github oxalica rust-overlay --branch master # Floats on pin bump, rustc pinned pinned by rust-lang rust
