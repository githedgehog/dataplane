...
/// Why a port-forwarding flow's keys could not be built.
///
/// Three unrelated things, which the caller's log line used to render identically because the
/// only thing it was handed was that something went wrong.
