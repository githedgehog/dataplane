...
/// Check whether `update_table` would accept this ruleset without modifying the table.
///
/// Call this before updating related tables to avoid partial configuration changes
/// if the port-forwarding rules are rejected.
