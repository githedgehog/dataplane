...
/// Why a masquerading flow could not be carried into a replacement allocator.
///
/// Two of these used to be silent: the flow was invalidated and nothing said why, because
/// `ok_or(())` had nothing to carry and no log next to it.
