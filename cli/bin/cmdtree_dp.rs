...
fn cmd_show_router_eventlog() -> Node {
    Node::new("events")
        ...
        .action(CliAction::RouterEventLog)
}
...
fn cmd_show_gateway() -> Node {
    ...
    root += Node::new("groups")
        ...
        .action(CliAction::ShowGatewayGroups);

    root += Node::new("communities")
        .desc("Show BGP communities used by gateways")
        .action(CliAction::ShowGatewayCommunities);
...
fn cmd_show_ip() -> Node {
    ...
    routes += Node::new("summary").action(CliAction::ShowRouterIpv4Routes);
...
fn cmd_show_evpn() -> Node {
    ...
    root += Node::new("vtep")
        ...
        .action(CliAction::ShowRouterEvpnVtep);
...
fn cmd_show_adjacency_table() -> Node {
    Node::new("adjacency-table")
        ...
        .action(CliAction::ShowAdjacencies)
}
...
fn cmd_show_flow_table() -> Node {
    ...
    root += Node::new("entries")
        ...
        .action(CliAction::ShowFlowTable);
...
fn cmd_show_flow_filter() -> Node {
    ...
    root += Node::new("table")
        ...
        .action(CliAction::ShowFlowFilter);
...
fn cmd_show_port_forwarding_rules() -> Node {
    ...
    root += Node::new("rules")
        ...
        .action(CliAction::ShowPortForwarding);
    root
}
fn cmd_show_masquerading() -> Node {
    ...
    root += Node::new("state")
        ...
        .action(CliAction::ShowMasquerading);
    root
}
fn cmd_show_static_nat() -> Node {
    ...
    root += Node::new("rules")
        ...
        .action(CliAction::ShowStaticNat);
    root
}
...
fn cmd_show_config_summary() -> Node {
    ...
    root += Node::new("summary")
        ...
        .action(CliAction::ShowConfigSummary);
    root += Node::new("internal")
        .desc("Show the internal configuration")
        .action(CliAction::ShowConfigInternal);
    root
}
...
fn cmd_local() -> Node {
    ...
    root += Node::new("q").action(CliAction::Quit).hidden();
    root += Node::new("?").action(CliAction::Help).hidden();
    root
}
...
fn cmd_frrmi_apply_last() -> Node {
    ...
    root += Node::new("last-config")
        ...
        .action(CliAction::FrrmiApplyLastConfig);
    root
}
fn cmd_frrmi() -> Node {
    let mut root = Node::new("frrmi");
...
fn cmd_cpi_request_refresh() -> Node {
    ...
    root += Node::new("refresh")
        ...
        .action(CliAction::CpiRequestRefresh);
    root
}
fn cmd_cpi() -> Node {
    let mut root = Node::new("cpi");
