...
///
/// If you use this type directly, you will need to write `AbstractIdType<*const X>` instead of `Id<X>`
/// or you will expose yourself to lifetime and co/contravariance concerns which have nothing to do
/// with this type.
///
...
/// ```
///
/// In this case the `list` function returning a list of user ids from a database of some kind.
