...
//!
//! Safety is achieved by wrapping th structure in left-right. Safety for readers is granted
...
//! (they are internally) and only the left-right writer deals with cloning them.
