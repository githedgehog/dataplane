...
/// Exercises control-plane operations through a complete [`RoutingDb`].
#[cfg(test)]
mod cpi_properties {
    use super::*;
    ...
    /// Build an underlay and one overlay vrf.
    fn fabric() -> RoutingDb {
    ...
    /// Assert executable entries with any drop instruction first.
