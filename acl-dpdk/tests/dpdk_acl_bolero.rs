...
fn classify_n<const N: usize>(
    ...
    let params = AclCreateParams::new::<N>("bolero_test", SocketId::ANY, max_rules as u32)
...
fn classify_cat_packets<const N: usize>(
    ...
    let params = AclCreateParams::new::<N>("bolero_cat", SocketId::ANY, max_rules as u32)
        .expect("create params");
    let mut ctx = AclContext::<N>::new(params).expect("create context");
