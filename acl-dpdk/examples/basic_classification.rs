...
fn simple_permit_deny() {
    ...
    println!(
        "  10.1.2.3:80  → {:?}",
        classifier.classify(&allowed, &()).fate()
    ); // Accept
    println!(
        "  192.168.1.1:80 → {:?}",
        classifier.classify(&blocked, &()).fate()
    ); // Drop
}
    ...
    let table = AclTableBuilder::new(Fate::Drop)
        .add_rule(
            ...
            AclRuleBuilder::new()
                ...
                .tcp(|tcp| {
                    tcp.dst = FieldMatch::Select(PortRange::new(1, 1023).unwrap());
                })
        ...
        .add_rule(
            ...
            AclRuleBuilder::new()
                ...
                .tcp(|tcp| {
                    tcp.dst = FieldMatch::Select(PortRange::exact(443));
                })
                .permit(Priority::new(100).unwrap()),
        )
        .build();
    ...
    let table = AclTableBuilder::new(Fate::Drop)
        ...
        .add_rule(
            ...
            AclRuleBuilder::new()
                ...
                .udp(|udp| {
                    udp.dst = FieldMatch::Select(PortRange::exact(53));
                })
                .permit(Priority::new(200).unwrap()),
        )
        .add_rule(
        ...
        (
            ...
            Box::new(|| {
                HeaderStack::new()
                    ...
                    .ipv4(|ip| {
                        ip.set_source(
                            net::ipv4::UnicastIpv4Addr::new(Ipv4Addr::new(10, 0, 0, 1)).unwrap(),
                        );
                    })
                    .tcp(|tcp| {
                        tcp.set_destination(net::tcp::port::TcpPort::new_checked(80).unwrap());
        ...
        (
            ...
            Box::new(|| {
                HeaderStack::new()
                    ...
                    .udp(|udp| {
                        udp.set_destination(net::udp::port::UdpPort::new_checked(53).unwrap());
                    })
                    .build_headers()
                    .unwrap()
            }),
        ...
        (
            ...
            Box::new(|| {
                HeaderStack::new()
                    ...
                    .tcp(|tcp| {
                        tcp.set_destination(net::tcp::port::TcpPort::new_checked(8080).unwrap());
                    })
                    .build_headers()
                    .unwrap()
            }),
        ...
        (
            ...
            Box::new(|| {
                HeaderStack::new()
                    ...
                    .tcp(|tcp| {
                        tcp.set_destination(net::tcp::port::TcpPort::new_checked(22).unwrap());
                    })
                    .build_headers()
                    .unwrap()
            }),
