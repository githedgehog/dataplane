...
nix --max-jobs 8 --extra-experimental-features nix-command build -f default.nix containers.dataplane-debugger --out-link /tmp/containers.dataplane-debugger.tar
docker import /tmp/containers.dataplane-debugger.tar dataplane-debugger:latest
