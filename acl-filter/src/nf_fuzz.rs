...
/// rather than picked.
///
/// Measured natively 2026-09-06: 27480 to 31616 probes drawn per property, at
/// `PROBES` per case, of which 24% were denied. One replayed corpus entry draws
/// `PROBES` and can legitimately deny none of them -- which is the failure this
