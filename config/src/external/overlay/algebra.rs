...
impl Draft {
    ...
    /// # Errors
    ///
    /// Returns the [`ConfigError`] from the first vpc, peering or overlay that the draft
    /// does not describe validly.
...
impl Undo {
    /// # Panics
    ///
    /// Panics if the draft is not the one this undo record was made against.
...
impl Sequence {
    ...
    /// # Panics
    ///
    /// Panics if any operation does not apply to the draft the ones before it produced.
    #[must_use]
