...
pub const GW_API_VERSION: Option<&str> = Some("v0.42.0");
...
pub struct GatewayAgentPeeringsPeeringExposeNat {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub masquerade: Option<GatewayAgentPeeringsPeeringExposeNatMasquerade>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "portForward")]
    pub port_forward: Option<GatewayAgentPeeringsPeeringExposeNatPortForward>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "static")]
    pub r#static: Option<GatewayAgentPeeringsPeeringExposeNatStatic>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, JsonSchema)]
pub struct GatewayAgentPeeringsPeeringExposeNatMasquerade {
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, JsonSchema)]
pub struct GatewayAgentPeeringsPeeringExposeNatPortForward {
    /// Time since the last packet after which flows are removed from the connection state table
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "idleTimeout")]
    pub idle_timeout: Option<kube_core::duration::Duration>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ports: Option<Vec<GatewayAgentPeeringsPeeringExposeNatPortForwardPorts>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, JsonSchema)]
pub struct GatewayAgentPeeringsPeeringExposeNatPortForwardPorts {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "as")]
    pub r#as: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub port: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub proto: Option<GatewayAgentPeeringsPeeringExposeNatPortForwardPortsProto>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, JsonSchema)]
pub enum GatewayAgentPeeringsPeeringExposeNatPortForwardPortsProto {
    #[serde(rename = "tcp")]
    Tcp,
    #[serde(rename = "udp")]
    Udp,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, JsonSchema)]
pub struct GatewayAgentPeeringsPeeringExposeNatStatic {
}
