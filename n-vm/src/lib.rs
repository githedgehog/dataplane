...
pub use config::{Accel, GuestHugePageConfig, GuestHugePageSize, HostPageSize, NicModel, VmConfig};
...
pub use n_vm_protocol::{
    ...
    KERNEL_CONSOLE_SOCKET_PATH, ScratchRootError, ScratchRoots, VHOST_VSOCK_SOCKET_PATH,
