...
use n_vm_protocol::{
    ...
    ScratchRoots, VM_ENV_DIR, VM_ROOT_SHARE_PATH, VM_RUN_DIR, VM_TEST_BIN_DIR, VM_WORKSPACE_DIR,
};
...
mod tests {
    ...
    fn config_propagates_backend_and_accel_env() {
        let config =
            sample_params().build_config(EffectiveBackend::Qemu, Accel::Tcg, None, None, None);
