...
//!
//! This module provides the [`Function`] type for representing PCI function
//! numbers. PCI devices can implement up to 8 functions (0-7), allowing a
//! single physical device to appear as multiple logical devices.
//!
